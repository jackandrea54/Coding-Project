...
//        System.out.println("By the way, my yob is " + yob);
        //Static ko thể biết có bao nhiêu vùng yob được clone để lấy in ra
        //nên nó quay về vùng static cho an toàn vì nó biết có 1 data để chọn
        //yob thuộc n objects, ko biết chọn đứa nào
    }
}
